...
declare module 'shards-react' {
    ...
    type FormInputProps = FormInputBaseProps & Omit<InputProps, keyof FormInputBaseProps>;
    ...
    type FormTextareaProps = FormTextareaBaseProps & Omit<TextareaProps, keyof FormTextareaBaseProps>;
